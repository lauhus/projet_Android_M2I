import { View, Text, Alert, TouchableHighlight, Image, ScrollView, ActivityIndicator } from "react-native";
            ...
            .then(response => {
                ...
                response.json().then(characters => {
                    this.setState({
                        ...
                        characters: this.state.gender != '' ? characters.filter((x) => x.gender === this.state.gender) : characters.sort((a, b) => (a.name > b.name ? 1 : -1)),
                        isLoading: false,
                    });
                });
            })
            ...
            <View style={styles.page}>
                <Text style={styles.title}>
                    <TouchableHighlight onPress={() =>this.props.navigation.goBack()}>
                        <Image source={{uri:'../../asset/arrowLeft'}} />
                    </TouchableHighlight>
                        {this.state.title}
                </Text>
                <ScrollView>
